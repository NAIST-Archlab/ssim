...
//{28,1,5,24,17,2},{12,17,3,12,32,2},{6,32,2,5,32,1},{5,32,2,4,64,1},{4,64,2,3,64,1}
  {28,1,5,24,17,2},{12,17,3,12,16,2},{6,16,2,6,32,1},{6,32,2,5,32,1},{5,32,2,4,64,1}
},
...
//{32,3,5,28,19,2},{14,19,3,14,16,2},{7,16,2,7,32,1},{7,32,2,6,32,2},{3,32,2,2,64,1},{2,64,2,1,64,1}
// 3072             3724              784             1568            288             256
  {32,3,5,28,19,2},{14,19,3,14,16,2},{7,16,2,7,32,1},{7,32,2,6,64,2},{3,64,2,2,64,1},{2,64,2,1,128,1}
...
void nn_forward(CNNet *net, struct c *c, struct f *f, float2D *oubatch, int spike_mode)
...
void nn_backprop(CNNet *net, struct c *c, struct f *f, float2D *gradout, int spike_mode)
{ /*--¤³¤³¤Ëhidden°Ê¹ß¤Î¤ß¤ò»È¤¦ºÙ¹©¤¬É¬Í×--*/
  float *A, *B;
  int i, l;
  ...
  if (spike_mode) {
    ...
    for (l=FC_DEPTH-1; l>=0; l--) {
      ...
      dropout2D(&(net->nflat[l]), &(net->nflat_dropoutmask[l])); // nflat:¡úDROPOUTÂÐ¾Ý
	...
	dropout4D(l==0?&(net->ninput):&(net->npool[l-1]), &(net->ninput_dropoutmask[l])); // ninput/npool:¡úDROPOUTÂÐ¾Ý
...
void nn_update(CNNet *net, float cnn_eta, float fc_eta, float wd, int spike_mode)
{ /*--¤³¤³¤Ëhidden°Ê¹ß¤Î¤ß¤ò»È¤¦ºÙ¹©¤¬É¬Í×--*/
  int l, i, j;
  float *A, *B;
