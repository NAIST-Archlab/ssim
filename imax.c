...
//EMAX5A begin back_g_ker mapdist=0
	...
	/*2*/ for (INIT1=1,LOOP1=M,rofs=(0-IMX4)<<32|((0-M4)&0xffffffff); LOOP1--; INIT1=0) {                            /* mapped to FOR() on BR[63][1][0] */ /* stage#0 */
		  ...
		  mop(OP_LDWR,  1, &b00,                   (Ull)kp0,  0LL,  MSK_W0,   (Ull)kp0,  1LL,    0, Force, NULL,   1LL);              /* stage#4 */
                  exe(OP_FAD,      &b00,      b00,         EXP_H3210, AR[3][0],       EXP_H3210, 0LL, EXP_H3210, OP_NOP,   0LL, OP_NOP, 0LL); /* stage#4 */
                  mop(OP_STWR,  1, &b00,                   (Ull)kp0,  0LL,  MSK_D0,   (Ull)kp0,  1LL,    0, Force, NULL,   1LL);              /* stage#4 */
                }
              }
            }
//EMAX5A end
...
//EMAX5A begin back_g_ker mapdist=0
      /*3*/ for (CHIP=0; CHIP<NCHIP; CHIP++) { /* output channels are parallelized by multi-chip (OC4/#chip) */
        /*2*/ for (INIT1=1,LOOP1=BATCH,img=(0-IMX4)<<32|((0-M4)&0xffffffff); LOOP1--; INIT1=0) {                           /* mapped to FOR() on BR[63][1][0] */ /* stage#0 */
		  ...
		  back_g_ker_core1( 4,  0,  2, Force); /**** oc0 ic2*****/
		  back_g_ker_core1( 5,  0,  3, Force); /**** oc0 ic3*****/
		  back_g_ker_core1( 6,  1,  0, Force); /**** oc1 ic0*****/
		  back_g_ker_core1( 7,  1,  1, Force); /**** oc1 ic1*****/
		  back_g_ker_core1( 8,  1,  2, Force); /**** oc1 ic2*****/
		  back_g_ker_core1( 9,  1,  3, Force); /**** oc1 ic3*****/
		  back_g_ker_core1(10,  2,  0, Force); /**** oc2 ic0*****/
		  back_g_ker_core1(11,  2,  1, Force); /**** oc2 ic1*****/
		  back_g_ker_core1(12,  2,  2, Force); /**** oc2 ic2*****/
		  back_g_ker_core1(13,  2,  3, Force); /**** oc2 ic3*****/
		  back_g_ker_core1(14,  3,  0, Force); /**** oc3 ic0*****/
		  back_g_ker_core1(15,  3,  1, Force); /**** oc3 ic1*****/
		  back_g_ker_core1(16,  3,  2, Force); /**** oc3 ic2*****/
		  back_g_ker_core1(17,  3,  3, Force); /**** oc3 ic3*****/
		  back_g_ker_core1(18,  4,  0, Force); /**** oc4 ic0*****/
		  back_g_ker_core1(19,  4,  1, Force); /**** oc4 ic1*****/
		  back_g_ker_core1(20,  4,  2, Force); /**** oc4 ic2*****/
		  back_g_ker_core1(21,  4,  3, Force); /**** oc4 ic3*****/
		  back_g_ker_core1(22,  5,  0, Force); /**** oc5 ic0*****/
		  back_g_ker_core1(23,  5,  1, Force); /**** oc5 ic1*****/
		  back_g_ker_core1(24,  5,  2, Force); /**** oc5 ic2*****/
		  back_g_ker_core1(25,  5,  3, Force); /**** oc5 ic3*****/
		  back_g_ker_core1(26,  6,  0, Force); /**** oc6 ic0*****/
		  back_g_ker_core1(27,  6,  1, Force); /**** oc6 ic1*****/
		  back_g_ker_core1(28,  6,  2, Force); /**** oc6 ic2*****/
		  back_g_ker_core1(29,  6,  3, Force); /**** oc6 ic3*****/
		  back_g_ker_core1(30,  7,  0, Force); /**** oc7 ic0*****/
		  back_g_ker_core1(31,  7,  1, Force); /**** oc7 ic1*****/
		  back_g_ker_core1(32,  7,  2, Force); /**** oc7 ic2*****/
		  back_g_ker_core1(33,  7,  3, Force); /**** oc7 ic3*****/
#endif
#if 1
		  back_g_ker_core1( 2,  0,  0, Force); /**** oc0  ic0*****/
		  back_g_ker_core1( 3,  0,  1, Force); /**** oc0  ic1*****/
...
#if 0
		  back_g_ker_core1( 2,  0,  0, Force); /**** oc0  ic0 *****/
		  back_g_ker_core1( 3,  1,  0, Force); /**** oc1  ic0 *****/
		  back_g_ker_core1( 4,  2,  0, Force); /**** oc2  ic0 *****/
		  back_g_ker_core1( 5,  3,  0, Force); /**** oc3  ic0 *****/
		  back_g_ker_core1( 6,  4,  0, Force); /**** oc4  ic0 *****/
		  back_g_ker_core1( 7,  5,  0, Force); /**** oc5  ic0 *****/
		  back_g_ker_core1( 8,  6,  0, Force); /**** oc6  ic0 *****/
		  back_g_ker_core1( 9,  7,  0, Force); /**** oc7  ic0 *****/
		  back_g_ker_core1(10,  8,  0, Force); /**** oc8  ic0 *****/
		  back_g_ker_core1(11,  9,  0, Force); /**** oc9  ic0 *****/
		  back_g_ker_core1(12, 10,  0, Force); /**** oc10 ic0 *****/
		  back_g_ker_core1(13, 11,  0, Force); /**** oc11 ic0 *****/
		  back_g_ker_core1(14, 12,  0, Force); /**** oc12 ic0 *****/
		  back_g_ker_core1(15, 13,  0, Force); /**** oc13 ic0 *****/
		  back_g_ker_core1(16, 14,  0, Force); /**** oc14 ic0 *****/
		  back_g_ker_core1(17, 15,  0, Force); /**** oc15 ic0 *****/
		  back_g_ker_core1(18, 16,  0, Force); /**** oc16 ic0 *****/
		  back_g_ker_core1(19, 17,  0, Force); /**** oc17 ic0 *****/
		  back_g_ker_core1(20, 18,  0, Force); /**** oc18 ic0 *****/
		  back_g_ker_core1(21, 19,  0, Force); /**** oc19 ic0 *****/
		  back_g_ker_core1(22, 20,  0, Force); /**** oc20 ic0 *****/
		  back_g_ker_core1(23, 21,  0, Force); /**** oc21 ic0 *****/
		  back_g_ker_core1(24, 22,  0, Force); /**** oc22 ic0 *****/
		  back_g_ker_core1(25, 23,  0, Force); /**** oc23 ic0 *****/
		  back_g_ker_core1(26, 24,  0, Force); /**** oc24 ic0 *****/
		  back_g_ker_core1(27, 25,  0, Force); /**** oc25 ic0 *****/
		  back_g_ker_core1(28, 26,  0, Force); /**** oc26 ic0 *****/
		  back_g_ker_core1(29, 27,  0, Force); /**** oc27 ic0 *****/
		  back_g_ker_core1(30, 28,  0, Force); /**** oc28 ic0 *****/
		  back_g_ker_core1(31, 29,  0, Force); /**** oc29 ic0 *****/
		  back_g_ker_core1(32, 30,  0, Force); /**** oc30 ic0 *****/
		  back_g_ker_core1(33, 31,  0, Force); /**** oc31 ic0 *****/
#endif
                }
              }
            }
  ...
  /*3*/ for (CHIP=0; CHIP<NCHIP; CHIP++) { /* output channels are parallelized by multi-chip (OC4/#chip) */
    /*2*/ for (INIT1=1,LOOP1=M,rofs=(0-M4)<<32|((0-IM4)&0xffffffff); LOOP1--; INIT1=0) {                             /* mapped to FOR() on BR[63][1][0] */ /* stage#0 */
      /*1*/ for (INIT0=1,LOOP0=M,cofs=(0-4LL)<<32|((0-4LL)&0xffffffff); LOOP0--; INIT0=0) {                          /* mapped to FOR() on BR[63][0][0] */ /* stage#0 */
	      ...
	      mop(OP_LDWR,  1, &BR[3][0][1],           (Ull)ip0,  iofs,  MSK_W0,  (Ull)it00, IMlen,  0, Force, NULL,   IMlen);            /* stage#3 */
	      ...
	      mop(OP_STWR,ex0, &AR[3][0],              iofs,   (Ull)ip0, MSK_D0,  (Ull)it00, IMlen,  0, Force, NULL,   IMlen);            /* stage#3 */
	    }
	  }
	}
//EMAX5A end
...
//EMAX5A begin back_in mapdist=0
	...
	/*2*/ for (INIT1=1,LOOP1=BATCH,img=(0-M4)<<32|((0-IM4)&0xffffffff); LOOP1--; INIT1=0) {                                       /* mapped to FOR() on BR[63][1][0] */ /* stage#0 */
	  /*1*/ for (INIT0=1,LOOP0=M,cofs=(0-4LL)<<32|((0-4LL)&0xffffffff); LOOP0--; INIT0=0) {                                       /* mapped to FOR() on BR[63][0][0] */ /* stage#0 */
		  ...
		  back_in_final(32, 34,  2, Force); /****OMAP( 8)+2,OMAP( 8)+4****/
		  /****ic3*****/
		  ...
		  back_in_final(43, 45,  3, Force); /****OMAP( 8)+2,OMAP( 8)+4****/
#endif
#if 1
		  /****ic0*****/
		  mop(OP_LDWR,  1, &BR[2][0][1],                   (Ull)op0[0], oofs,          MSK_W1,    (Ull)ot0[0], Mlen,      0,      0,                    NULL,   Mlen);  /* stage#2 */
		  ...
		  back_in_final(34, 36,  0, Force); /****OMAP(32)+2,OMAP(32)+4****/
#endif
	        }
	      }
            }
